    ...
    <div style="margin-top: 50px">
      <el-form :model="form" :rules="rules" @validate="onValidate" ref="formRef">
        ...
        <el-form-item prop="teacher_id">
          <el-input v-model="form.teacher_id" :maxlength="6" type="password" placeholder="教师编号(如果您是学生，请忽略)">
            <template #prefix>
              <el-icon><Lock /></el-icon>
            </template>
          </el-input>
...
const rules = {
  ...
  teacher_id: [
    { validator: validateTeacherId, trigger: ['blur', 'change'] },
  ]
}
